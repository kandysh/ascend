...
✅ **Production Ready** - Automatically uses system env vars in production
...
- Services load `.env` file automatically
- Great for local development

### Production

- Set `NODE_ENV=production`
- Services skip `.env` file loading
...
# Production
NODE_ENV=production DATABASE_URL=postgres://... node dist/index.js
```

See **[Production Deployment Guide](./production-deployment.md)** for complete production setup.
